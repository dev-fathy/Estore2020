    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <!-- <img src="{{ config('app.asset_url') }}/img/4.png" class="brand" alt=""> -->
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="{{ url('projects/display') }}">Products</a></li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right  login-dropdown" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item logout-button" href="{{ route('logout') }}" onclick="event.preventDefault();
